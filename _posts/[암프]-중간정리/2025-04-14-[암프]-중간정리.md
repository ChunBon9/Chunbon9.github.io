...
- [Computing power of users(attackers)](#computing-power-of-usersattackers)
- [A negligible function](#a-negligible-function)
- [One-way function](#one-way-function)
  - [Constructions of hardcore predicates](#constructions-of-hardcore-predicates)
  - [Goldreich and Levin's consturction](#goldreich-and-levins-consturction)
- [Commitment Schemes](#commitment-schemes)
  - [Security properties](#security-properties)
  - [Two type of commitment schemes](#two-type-of-commitment-schemes)
- [Oblivious Transfer (Private Information Retrieval)](#oblivious-transfer-private-information-retrieval)
  - [1-out-of 2 OT](#1-out-of-2-ot)
  - [1-out-of-4 OT](#1-out-of-4-ot)
  - [1-out-of-N OT from 1-out-of-2](#1-out-of-n-ot-from-1-out-of-2)
- [Digital Signature](#digital-signature)
  - [Security property](#security-property)
- [Blind Signature](#blind-signature)
  - [A blind signature scheme from RSA](#a-blind-signature-scheme-from-rsa)
  - [A blind signature scheme from DLP](#a-blind-signature-scheme-from-dlp)
- [Basic e-cash model](#basic-e-cash-model)
  - [e-cash requirement in the central bank model](#e-cash-requirement-in-the-central-bank-model)
  - [Types of anonymity control](#types-of-anonymity-control)
  - [The methods of anonymity control](#the-methods-of-anonymity-control)
  - [Brands e-cash scheme](#brands-e-cash-scheme)
- [Ring signature (useful for whistle blowing)](#ring-signature-useful-for-whistle-blowing)
...
하지만 party의 구성원이 아니라면 \\(c == c_1 + c_2 + ... + c_{\pi} + ... + c_n\\)를 만족 못 시킴  
\\(\rightarrow \\) unforgeability  

**Ring signature verification for \\((m, c_1, ..., s_1, ...)\\)**  
1. Check \\(c == H(m\|g^{s_1}y^{c_1}\|g^{s_2}y^{c_2}...)\\)  
2. Check \\(c == c_1 + c_2 + ... + c_n\\)
